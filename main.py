...
from ui_main_my import Ui_MainWindow # MAINWINDOW CODE GENERATED BY THE QT DESIGNER AND pyside2-uic.
...
class MainWindow(QMainWindow):
    def __init__(self, version, user="debug"):
        ...
        for i in range(1,7):
            ...
            frame = self.ui.__dict__['frame_group_{0}'.format(i)]
            self.measurementGroups[groupName] = MeasurementGroup(self, groupName, button, frame)
